...
export class AdivinaElNumeroComponent implements OnInit{
 @Output() enviarJuego: EventEmitter<any>= new EventEmitter<any>();
  ...
  constructor(
    ...
    if(this.jugador){      
      this.nuevoJuego = new JuegoAdivina("adivina el numero",false,this.jugador.correo);
      ...
      switch (this.contador) {
        case 1:
          ...
          case 20:
            ...
            this.nuevoJuego.guardarDatos();
            this.MostarMensaje("Perdiste, se asigna un nuevo numero",this.nuevoJuego.gano);
            this.generarnumero();
          break;
